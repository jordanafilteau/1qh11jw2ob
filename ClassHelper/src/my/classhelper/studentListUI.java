...
public class studentListUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form studentListUI
     */
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("ID Number");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Major");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Year");
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Attendance");
        }
